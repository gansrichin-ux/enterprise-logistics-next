    ...
    <header className="sticky top-0 z-30 border-b border-border/60 bg-background/70 backdrop-blur-xl">
      <div className="mx-auto flex h-16 max-w-7xl items-center justify-between px-5 lg:px-10">
        ...
        <nav className="hidden items-center gap-8 md:flex">
          <a href="#platform" className="text-[13px] text-muted-foreground hover:text-foreground">Platform</a>
          <a href="#roles" className="text-[13px] text-muted-foreground hover:text-foreground">Who it's for</a>
          <a href="#operations" className="text-[13px] text-muted-foreground hover:text-foreground">Operations</a>
          <a href="#pricing" className="text-[13px] text-muted-foreground hover:text-foreground">Pricing</a>
        </nav>
    ...
    <footer className="border-t border-border/60 bg-background">
      <div className="mx-auto grid max-w-7xl gap-10 px-5 py-14 lg:grid-cols-4 lg:px-10">
        <div>
          ...
          <p className="mt-4 max-w-xs text-[13px] text-muted-foreground">
            The operating system for modern freight. Built for cargo owners, carriers, logisticians and forwarders.
          </p>
        </div>
        {[
          { h: "Platform", l: ["Cargo management", "Transport search", "Route tracking", "Company cabinet"] },
          { h: "Company", l: ["About", "Careers", "Press", "Contact"] },
          { h: "Legal", l: ["Terms", "Privacy", "Cookies", "GDPR"] },
        ].map((c) => (
          <div key={c.h}>
      ...
      <div className="border-t border-border/60">
        <div className="mx-auto flex max-w-7xl flex-col items-center justify-between gap-2 px-5 py-5 text-[11px] text-muted-foreground lg:flex-row lg:px-10">
          ...
          <div className="font-mono uppercase tracking-wider">EU · Hamburg · Tallinn · Madrid</div>
        </div>
      </div>
    </footer>
  );
